...
class LostScreenFragment : Fragment() {
   ...
   private var chatAdapter:ChatAdapter?=null
    ...
    override fun onCreateView(
        ...
        mdatabaseref=FirebaseDatabase.getInstance().getReference("Lost_Chats")
       ...
       val  view=inflater.inflate(R.layout.fragment_lost_screen, container, false)
        ...
        recyclerviewchats=view.findViewById(R.id.message_recycler_lost)
        ...
        mdatabasereferce2.addValueEventListener(object:ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for(snapshot2 in snapshot.children)
                {
                    ...
                    chatAdapter=ChatAdapter(view.context,mchatlist as kotlin.collections.ArrayList<Chat>)
